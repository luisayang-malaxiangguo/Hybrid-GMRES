function [x, error_norm, residual_norm, niters] = BAgmres_own(A, B, b, x_true,tol, maxit)
%BA-GMRES_OWN  Solve BA*x = Bb using GMRES on the normal‐equations form
%
%   [x, error_norm, residual_norm, niters] =
%       BAgmres_own(BA, b, tol, maxit)
%
%   Inputs:
%     BA      – square (n×n) matrix
%     b       – vector 
